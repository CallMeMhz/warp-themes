...
![Nord Light Theme](screenshots/nord-light.png)

### Everforest Dark Hard

A green-based color scheme designed to be warm and comfortable for your eyes.

![Everforest Dark Hard Theme](screenshots/everforest-dark-hard.png)
